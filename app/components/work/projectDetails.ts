...
`,
...

  {
    ...
    name: "#0123",
    description:
      "#0123 is a first-person shooter that combines immersive narrative elements with dynamic, high-intensity combat. Set on an enigmatic, uncharted planet, the game challenges players to navigate the aftermath of a catastrophic spaceship crash while combating relentless alien adversaries.",
    ...
    images: [
      {
        src: "/pcg/1.png",
        alt: "Unreal BluePrints",
        desc: "This is the initial version of the cave, created using procedural content generation (PCG) code and refined with the modeling tab in Unreal Engine. It combines automated design elements with manual adjustments to lay the groundwork for the environment.",
      },
      {
        src: "/pcg/2.png",
        alt: "Cave 2",
      ...
      },
      {
        ...
        desc: "I also developed a master material that serves as a flexible base for customization. This material can be easily modified to represent various elements—such as crystals, gold, and stones—ensuring consistent visual quality and efficient adjustments to meet evolving project requirements.",
      },
      {
        src: "/pcg/8.png",
        alt: "Pcg Graph Photo",
        title: "Pcg Graph",
        desc: "I created a PCG graph that automates the placement of environmental elements—such as stone, gold, crystal, and water—eliminating the need for manual placement and streamlining the scene creation process.",
      },
      // {
      //   src: "/pcg/9.png",
      //   alt: "Cave 9",
